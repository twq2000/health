...
public class MessageConstants {
  ...
  public static final String UPDATE_CHECKITEM_SUCCESS = "编辑检查项成功";
  public static final String UPDATE_CHECKITEM_FAIL = "编辑检查项失败";
  ...
  public static final String UPDATE_CHECKGROUP_SUCCESS = "编辑检查组成功";
  public static final String UPDATE_CHECKGROUP_FAIL = "编辑检查组失败";
  ...
  public static final String VALIDATECODE_EMPTY = "请输入验证码";
  ...
  public static final String SELECTED_DATE_CANNOT_ORDER = "所选日期暂不开放体检预约";
  public static final String ORDER_FULL = "预约已满";
  public static final String HAS_ORDERED = "您已预约，请勿重复预约";
